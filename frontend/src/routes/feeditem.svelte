...
<div class="feeditem" in:slide={{ duration: 200, axis: 'x'}}>
  <div class="feeditem-header flex items-center justify-between gap-3 w-full">
    <h2 class="feeditem-command">{command_name}</h2>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-stone-900 ml-4">
